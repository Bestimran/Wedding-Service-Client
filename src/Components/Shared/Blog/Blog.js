...
const Blog = () => {
  return (
    <div className="bg-base-200 mt-20">
      <div className="max-w-[1300px] bg-white-200 mx-auto px-5 py-10">
        <h1 className="text-center text-4xl bg-white py-3">
      ...
      <div className="bg-grey-200 max-w-[1300px] py-10 mx-auto px-5">
        <h3 className="text-center text-4xl bg-white py-3">
          What is JWT, and how does it work?
        </h3>
        <p className="text-xl text-grey mt-3">
      ...
      <div className="max-w-[1300px] bg-grey-200 mx-auto px-5 py-10">
        <h2 className="text-4xl text-center bg-white py-3">
          What is Different Between NodeJs And Javascript
        </h2>
        <p className="text-xl mt-5">
          ...
          JavaScript programming language.NodeJS is a cross-platform and
          ...
          used in web development. Javascript is a Scripting language. It is
      ...
      <div className="max-w-[1300px] mx-auto px-5 py-10">
        <h2 className="text-4xl  bg-white py-3 text-center">
